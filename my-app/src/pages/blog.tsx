            ...
            <div className="max-w-4xl mx-auto px-4">
                ...
                {posts.length > 0 ? (
                    <div className="space-y-10">
                        {posts.map((post) => (
                            <div key={post.$id} className="card bg-base-200 shadow-xl hover:shadow-2xl transition-shadow duration-300">
                                <div className="card-body p-8">
                                    <h2 className="card-title text-3xl font-bold mb-4 text-accent">{post.title}</h2>
