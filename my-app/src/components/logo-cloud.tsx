        ...
        <div className="bg-base-100 py-14 sm:py-16">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <p className="py-6">
                    ...
                    <span className="font-bold">DaisyUI, Appwrite</span> Auth
                    and Databases. <span className="font-bold">Oxlint</span> for
                    Linting and <span className="font-bold">Prettier</span> for
                    Formatting.
                </p>
